package pt.uc.dei.aor.pf.urlQueries;
	...
	public boolean processQuery(){
		...
		if(request.getQueryString()!=null){
			...
			if(this.subject!=null){
				...
				if(this.subject.equals(Constants.QUERY_SUBJECT_AUTH_CANDIDATE)) this.processedQueryResult=this.urlQueriesEJB.authenticateCandidate(request.getParameter(Constants.QUERY_EMAIL));
